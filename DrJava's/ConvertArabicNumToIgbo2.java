/*
 * Personal Project: To minimize (or simplify) the program
 * using the method, 'ActionMethod', so that there won't
 * a repitition of "Ihe o putara na okwu igbo bu:..." in the 
 * various cases.
 * 
 * */
import java.util.Scanner;

public class ConvertArabicNumToIgbo2 { 
...
Scanner tough = new Scanner (System.in);

System.out.println ("Kedu akara Arabik di n'obi gi?"); // prompts input of arabic numeral

int num = tough.nextInt();
//ActionMethod;
